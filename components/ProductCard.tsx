...
const toneTokens = {
  dark: {
    ...
    chevronBg: "bg-white/10 text-white",
  },
  light: {
    ...
    chevronBg: "bg-[#0F1724]/5 text-[#0F1724]",
  },
} as const;
    ...
    >
      <div className={`relative flex h-full flex-col justify-between rounded-[18px] border p-6 transition-colors ${styles.card}`}>
        ...
        <div className="mt-8 flex items-center justify-between">
          <Link
            href={href}
            className={`interactive-cta inline-flex items-center gap-2 text-[0.72rem] font-semibold uppercase tracking-[0.3em] ${styles.link}`}
          >
            <span>View</span>
            <span
              aria-hidden="true"
