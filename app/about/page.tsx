        ...
        >
            <div className="space-y-4 text-base text-gray-700">
              {aboutIntro.map((paragraph, index) => (
                <MotionReveal key={paragraph} as="p" delay={index * 0.05} splitText className="text-base text-gray-700">
                  {paragraph}
                </MotionReveal>
              ))}
              <MotionReveal as="p" delay={aboutIntro.length * 0.05} splitText className="text-base text-gray-700">
                We have capabilities to develop product from concept, solve complex problems or simply provide engineering
                resources.
              </MotionReveal>
              <MotionReveal as="p" delay={aboutIntro.length * 0.05 + 0.08} splitText className="text-base text-gray-700">
